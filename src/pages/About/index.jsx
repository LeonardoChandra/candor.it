      ...
      <section id="ABOUT">
        ...
        <section id="about__hero">
          <div className="about__hero_container">
            <div className="about__hero_text-title">
              <h1 className="about__hero_main-title">
                ...
                <span className="about__hero_title-image">
                  <img src="/about/about-1.png" />
                </span>
                is
                <br />
                <span className="about__hero_title-image">
                  <img src="/about/about-2.png" />
                </span>
                Known for
                <br />
                Innovation
            ...
            <div className="about__hero_img">
              <img src="/project/project-1/project-desc.png" className="about__hero_img-item1" />
              <img src="/project/project-2/project-desc.png" className="about__hero_img-item2" />
              <img src="/project/project-3/project-desc.png" className="about__hero_img-item1" />
            </div>
          </div>
        </section>
        {/* =================================== Body =================================== */}
        <section id="about__body">
          <div className="about__body_container">
            ...
            <div className="about__body_description">
              ...
              <img src="/about/about-3.png" className="about__body_img-item1" />
            </div>
          </div>
        </section>
        {/* =================================== Last =================================== */}
        <section id="about__last">
          <div className="about__body_body-container">
            ...
            <img src="/about/about-4.png" className="about__body_body-img" />
          </div>
        </section>
        {/* =================================== Contact & Footer =================================== */}
        <section id="contact">
