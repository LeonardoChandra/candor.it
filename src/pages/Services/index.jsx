        ...
        <section id="services__hero">
          ...
          <div className="services__item_container">
            <div className="services__item-website">
              ...
              <img src="/services/services-1.png" className="services__item-website-img" />
            </div>
            <div className="services__item-website">
              <img src="/services/services-2.png" className="services__item-mobile-img" />
              <div className="services__item-website-text">
            ...
            <div className="services__item-website">
              ...
              <img src="/services/services-3.png" className="services__item-ai-img" />
            </div>
          </div>
        </section>
        {/* =================================== Contact & Footer =================================== */}
